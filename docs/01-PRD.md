...
| **5** | Открытый публичный доступ, биллинг/лимиты, локализация |
...
|---|---|---|---|---|
| 00 | Итерация 1: визард, Google + iCloud, список и удаление | В разработке | этот документ | — |
| 01 | *(следующая)* | | `docs/features/01-....md` | |
